package com.test.springjpademo.advice;
...
public class LoggingAspect {
		...
		@Before("execution(* com.test.springjpademo.StudentController.*(..))")
		...
		@AfterReturning(value = "execution(*  com.test.springjpademo.jms.*.*(..))", 
				returning = "result")
